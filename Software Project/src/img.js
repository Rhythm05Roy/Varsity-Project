!(function e(t, r, n) {
...
})(
  {
    ...
    7: [
      ...
      { "./BasePostMessageStream": 5, "./enums": 9 },
    ],
    8: [
      function (e, t, r) {
        "use strict";
    ...
    12: [
      ...
      { "./_stream_transform": 14, "core-util-is": 40, inherits: 49 },
    ],
    13: [
      function (e, t, r) {
        (function (r, n) {
    ...
    14: [
      ...
      { "./_stream_duplex": 11, "core-util-is": 40, inherits: 49 },
    ],
    15: [
      function (e, t, r) {
        (function (r, n, i) {
              ...
              if (e._writev && r && r.next) {
                ...
                for (; r; ) {
                  var l = r.chunk,
                    ...
                    d = r.callback;
                  if (
                    (w(e, t, !1, t.objectMode ? 1 : l.length, l, c, d),
                    (r = r.next),
                    t.writing)
                  )
                    break;
                ...
                ? ((p = Function.prototype[Symbol.hasInstance]),
                  Object.defineProperty(b, Symbol.hasInstance, {
                    value: function (e) {
                      return (
                        !!p.call(this, e) ||
                        (e && e._writableState instanceof y)
                      );
                    },
                  }))
                : (p = function (e) {
            ...
            if (
              ...
              (this._state.isConnected = !1),
                e
                  ...
                  : ((r = new o.EthereumRpcError(
                      1011,
                      t || u.default.errors.permanentlyDisconnected()
                    )),
                    this._log.error(r),
                    (this.chainId = null),
      ...
      function (e, t, r) {
        ...
        class d extends c.BaseProvider {
          constructor(
            ...
            if (
              (super({ logger: r, maxEventListeners: n, rpcMiddleware: c }),
              !o.duplex(e))
            )
              ...
              this._jsonRpcConnection.events.on("notification", (t) => {
                ...
                "metamask_accountsChanged" === r
                  ...
                  : "METAMASK_STREAM_FAILURE" === r &&
                    e.destroy(
                      new Error(u.default.errors.permanentlyDisconnected())
                    );
              });
          }
      ...
      function (e, t, r) {
        ...
        (r.initializeProvider = function ({
          ...
          const c = new n.MetaMaskInpageProvider(e, {
            ...
            d = new Proxy(c, { deleteProperty: () => !0 });
          return u && o(d), l && i.shimWeb3(d, r), d;
        }),
          (r.setGlobalProvider = o);
      },
      { "./MetaMaskInpageProvider": 23, "./shimWeb3": 28 },
    ],
    26: [
      function (e, t, r) {
        "use strict";
    ...
    27: [
      function (e, t, r) {
        ...
        r.createRpcWarningMiddleware = function (e) {
          ...
          return (r, n, o) => {
            !1 === t.ethDecryptDeprecation && "eth_decrypt" === r.method
              ...
              : !1 === t.ethGetEncryptionPublicKeyDeprecation &&
                ...
                (e.warn(
                  i.default.warnings.rpc.ethGetEncryptionPublicKeyDeprecation
                ),
    ...
    33: [
      ...
      { "@metamask/safe-event-emitter": 35, "readable-stream": 76 },
    ],
    34: [
      function (e, t, r) {
        "use strict";
            ...
            if (
              ...
              (l.code = t.code),
                t.message && "string" == typeof t.message
                  ? ((l.message = t.message), d(t, "data") && (l.data = t.data))
                  : ((l.message = a(l.code)),
        ...
        !(function (e, r) {
          ...
          return (
            (l.noConflict = function () {
              return (
                typeof window !== t && window.log === l && (window.log = d), l
              );
            }),
    ...
    64: [
      ...
      { _process: 63, "end-of-stream": 41, fs: 37, once: 61 },
    ],
    65: [
      function (e, t, r) {
        "use strict";
    ...
    66: [
      ...
      { "./_stream_transform": 68, "core-util-is": 40, inherits: 49 },
    ],
    67: [
      function (e, t, r) {
        (function (r, n) {
    ...
    68: [
      ...
      { "./_stream_duplex": 65, "core-util-is": 40, inherits: 49 },
    ],
    69: [
      function (e, t, r) {
        (function (r, n, i) {
            ...
            l.inherits(b, d),
              ...
              (b.prototype.write = function (e, t, r) {
                var n,
                  ...
                  s = !1,
                  a =
                    !i.objectMode && ((n = e), f.isBuffer(n) || n instanceof h);
                return (
                  a &&
                    !f.isBuffer(e) &&
                    (e = (function (e) {
    ...
    77: [
      ...
      { "process/browser.js": 63, timers: 77 },
    ],
    78: [
      function (e, t, r) {
        (function (e) {
